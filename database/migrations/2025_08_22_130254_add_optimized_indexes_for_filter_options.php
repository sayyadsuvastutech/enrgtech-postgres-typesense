...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('products', function (Blueprint $table) {
            ...
            $table->index(['category_id', 'status'], 'products_category_status_count_idx');
            
            // Optimize COUNT queries for brand filter options  
            $table->index(['brand_id', 'status'], 'products_brand_status_count_idx');
            
            // Optimize COUNT queries for manufacturer filter options
            $table->index(['manufacturer_id', 'status'], 'products_manufacturer_status_count_idx');
            
            // Optimize price range queries with status filter
            $table->index(['status', 'price'], 'products_status_price_range_idx');
        });
    ...
    public function down(): void
    {
        Schema::table('products', function (Blueprint $table) {
            ...
            $table->dropIndex('products_status_price_range_idx');
        });
